...
from e3covernet.in_out.arguments import parse_arguments
from e3covernet.in_out.neural_net_oriented import load_scan_related_data, load_referential_data
from e3covernet.in_out.neural_net_oriented import compute_auxiliary_data, trim_scans_per_e3covernet_data
from e3covernet.in_out.pt_datasets.listening_dataset import make_data_loaders
from e3covernet.utils import set_gpu_to_zero_position, create_logger, seed_training_code
from e3covernet.utils.tf_visualizer import Visualizer
from e3covernet.models.e3covernet import instantiate_e3covernet
from e3covernet.models.e3covernet_utils import single_epoch_train, evaluate_on_dataset
from e3covernet.models.utils import load_state_dicts, save_state_dicts
from e3covernet.analysis.deepnet_predictions import analyze_predictions
...
if __name__ == '__main__':
    ...
    # Read the linguistic data of E3CoverNet
    e3cover_data = load_referential_data(args, args.e3covernet_file, scans_split)

    # Prepare data & compute auxiliary meta-information.
    all_scans_in_dict = trim_scans_per_e3covernet_data(e3cover_data, all_scans_in_dict)
    mean_rgb, vocab = compute_auxiliary_data(e3cover_data, all_scans_in_dict, args)
    data_loaders = make_data_loaders(args, e3cover_data, vocab, class_to_idx, all_scans_in_dict, mean_rgb)
    ...
    model = instantiate_e3covernet(args, vocab, n_classes).to(device)
