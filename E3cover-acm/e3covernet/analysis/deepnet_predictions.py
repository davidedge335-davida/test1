...
Copyright (c) 2026 Panos Achlioptas (pachlioptas@gmail.com) & Stanford Geometric Computing Lab
"""
...
from ..models.e3covernet_utils import detailed_predictions_on_dataset
...
def analyze_predictions(model, dataset, class_to_idx, pad_idx, device, args, out_file=None, visualize_output=True):
    ...
    if visualize_output:
        from e3covernet.utils import pickle_data
