...
Copyright (c) 2026 Panos Achlioptas (pachlioptas@gmail.com) & Ahmed (@gmail.com)
"""
...
def parse_arguments(notebook_options=None):
    """Parse the arguments for the training (or test) execution of a E3CoverNet net.
    :param notebook_options: (list) e.g., ['--max-distractors', '100'] to give/parse arguments from inside a jupyter notebook.
    :return:
    """
    parser = argparse.ArgumentParser(description='E3CoverNet Nets + Ablations')
    ...
    parser.add_argument('-e3covernet-file', type=str, required=True)
    ...
    # Model arguments
    #
    parser.add_argument('--model', type=str, default='E3CoverNet', choices=['E3CoverNet',
                                                                              'directObj2Lang',
                                                                              'E3CoverNetAttentive'])
